...
extension TextFormFieldStyleHelper on CustomTextFormField {
  ...
  static OutlineInputBorder get fillGray200TL14 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            14.00,
          ),
  ...
  static OutlineInputBorder get fillLightgreen800 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            6.00,
          ),
  ...
  static OutlineInputBorder get fillDeeporangeA200 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            6.00,
          ),
