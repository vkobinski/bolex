import 'bloc/bolex_fiftyseven_bloc.dart';
import 'models/bolex_fiftyseven_model.dart';
...
class BolexFiftysevenScreen extends StatelessWidget {
  const BolexFiftysevenScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<BolexFiftysevenBloc>(
      create: (context) => BolexFiftysevenBloc(BolexFiftysevenState(
        bolexFiftysevenModelObj: BolexFiftysevenModel(),
      ))
        ..add(BolexFiftysevenInitialEvent()),
      child: BolexFiftysevenScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BolexFiftysevenBloc, BolexFiftysevenState>(
