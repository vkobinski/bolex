import 'bloc/meu_perfil_three_bloc.dart';
import 'models/meu_perfil_three_model.dart';
...
class MeuPerfilThreeScreen extends StatelessWidget {
  const MeuPerfilThreeScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<MeuPerfilThreeBloc>(
      create: (context) => MeuPerfilThreeBloc(MeuPerfilThreeState(
        meuPerfilThreeModelObj: MeuPerfilThreeModel(),
      ))
        ..add(MeuPerfilThreeInitialEvent()),
      child: MeuPerfilThreeScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MeuPerfilThreeBloc, MeuPerfilThreeState>(
