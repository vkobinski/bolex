import 'bloc/cobrar_thirtyfour_bloc.dart';
import 'models/cobrar_thirtyfour_model.dart';
...
class CobrarThirtyfourScreen extends StatelessWidget {
  const CobrarThirtyfourScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarThirtyfourBloc>(
      create: (context) => CobrarThirtyfourBloc(CobrarThirtyfourState(
        cobrarThirtyfourModelObj: CobrarThirtyfourModel(),
      ))
        ..add(CobrarThirtyfourInitialEvent()),
      child: CobrarThirtyfourScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarThirtyfourBloc, CobrarThirtyfourState>(
                ...
                children: [
                  SizedBox(
                    ...
                    child: Stack(
                      ...
                      children: [
                        CustomImageView(
                          imagePath: ImageConstant.imgRectangle745,
                          height: getVerticalSize(
                            44,
                          ),
                          width: getHorizontalSize(
