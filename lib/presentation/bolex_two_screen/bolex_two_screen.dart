import 'bloc/bolex_two_bloc.dart';
import 'models/bolex_two_model.dart';
...
class BolexTwoScreen extends StatelessWidget {
  const BolexTwoScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<BolexTwoBloc>(
      create: (context) => BolexTwoBloc(BolexTwoState(
        bolexTwoModelObj: BolexTwoModel(),
      ))
        ..add(BolexTwoInitialEvent()),
      child: BolexTwoScreen(),
    );
  }
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              BlocSelector<BolexTwoBloc, BolexTwoState, TextEditingController?>(
