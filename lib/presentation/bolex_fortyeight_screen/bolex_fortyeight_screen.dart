import 'bloc/bolex_fortyeight_bloc.dart';
import 'models/bolex_fortyeight_model.dart';
...
class BolexFortyeightScreen extends StatelessWidget {
  const BolexFortyeightScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<BolexFortyeightBloc>(
      create: (context) => BolexFortyeightBloc(BolexFortyeightState(
        bolexFortyeightModelObj: BolexFortyeightModel(),
      ))
        ..add(BolexFortyeightInitialEvent()),
      child: BolexFortyeightScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BolexFortyeightBloc, BolexFortyeightState>(
