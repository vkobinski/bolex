import 'bloc/cobrar_eight_bloc.dart';
import 'models/cobrar_eight_model.dart';
...
class CobrarEightScreen extends StatelessWidget {
  const CobrarEightScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarEightBloc>(
      create: (context) => CobrarEightBloc(CobrarEightState(
        cobrarEightModelObj: CobrarEightModel(),
      ))
        ..add(CobrarEightInitialEvent()),
      child: CobrarEightScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarEightBloc, CobrarEightState>(
