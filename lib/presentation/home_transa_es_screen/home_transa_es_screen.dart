import '../home_transa_es_screen/widgets/aes_item_widget.dart';
import 'bloc/home_transa_es_bloc.dart';
import 'models/aes_item_model.dart';
import 'models/home_transa_es_model.dart';
...
class HomeTransaEsScreen extends StatelessWidget {
  const HomeTransaEsScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<HomeTransaEsBloc>(
      create: (context) => HomeTransaEsBloc(HomeTransaEsState(
        homeTransaEsModelObj: HomeTransaEsModel(),
      ))
        ..add(HomeTransaEsInitialEvent()),
      child: HomeTransaEsScreen(),
    );
  }
                    ...
                    children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: BlocSelector<HomeTransaEsBloc,
                                    HomeTransaEsState, bool?>(
                                  ...
                                  builder: (context, isCheckbox) {
                                    return CustomCheckboxButton(
                                      ...
                                      isRightCheck: true,
                                      onChange: (value) {
                                        context.read<HomeTransaEsBloc>().add(
                      ...
                      Align(
                        ...
                        child: SizedBox(
                          ...
                          child: BlocSelector<HomeTransaEsBloc,
                              HomeTransaEsState, HomeTransaEsModel?>(
                            selector: (state) => state.homeTransaEsModelObj,
                            builder: (context, homeTransaEsModelObj) {
                              return ListView.separated(
                                ...
                                itemCount:
                                    homeTransaEsModelObj?.aesItemList.length ??
                                        0,
                                itemBuilder: (context, index) {
                                  AesItemModel model = homeTransaEsModelObj
                                          ?.aesItemList[index] ??
                                      AesItemModel();
                                  return AesItemWidget(
                                    model,
                                  );
                                },
                              );
