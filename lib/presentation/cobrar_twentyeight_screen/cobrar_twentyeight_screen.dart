import 'bloc/cobrar_twentyeight_bloc.dart';
import 'models/cobrar_twentyeight_model.dart';
...
class CobrarTwentyeightScreen extends StatelessWidget {
  const CobrarTwentyeightScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarTwentyeightBloc>(
      create: (context) => CobrarTwentyeightBloc(CobrarTwentyeightState(
        cobrarTwentyeightModelObj: CobrarTwentyeightModel(),
      ))
        ..add(CobrarTwentyeightInitialEvent()),
      child: CobrarTwentyeightScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarTwentyeightBloc, CobrarTwentyeightState>(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "lbl_por_revoga_o2".tr.toUpperCase(),
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.left,
