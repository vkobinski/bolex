import 'bloc/bolex_nineteen_bloc.dart';
import 'models/bolex_nineteen_model.dart';
...
class BolexNineteenScreen extends StatelessWidget {
  const BolexNineteenScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<BolexNineteenBloc>(
      create: (context) => BolexNineteenBloc(BolexNineteenState(
        bolexNineteenModelObj: BolexNineteenModel(),
      ))
        ..add(BolexNineteenInitialEvent()),
      child: BolexNineteenScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BolexNineteenBloc, BolexNineteenState>(
