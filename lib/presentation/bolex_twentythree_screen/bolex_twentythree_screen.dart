import 'bloc/bolex_twentythree_bloc.dart';
import 'models/bolex_twentythree_model.dart';
...
class BolexTwentythreeScreen extends StatelessWidget {
  const BolexTwentythreeScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<BolexTwentythreeBloc>(
      create: (context) => BolexTwentythreeBloc(BolexTwentythreeState(
        bolexTwentythreeModelObj: BolexTwentythreeModel(),
      ))
        ..add(BolexTwentythreeInitialEvent()),
      child: BolexTwentythreeScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BolexTwentythreeBloc, BolexTwentythreeState>(
