import 'bloc/cobrar_seventeen_bloc.dart';
import 'models/cobrar_seventeen_model.dart';
...
class CobrarSeventeenScreen extends StatelessWidget {
  const CobrarSeventeenScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarSeventeenBloc>(
      create: (context) => CobrarSeventeenBloc(CobrarSeventeenState(
        cobrarSeventeenModelObj: CobrarSeventeenModel(),
      ))
        ..add(CobrarSeventeenInitialEvent()),
      child: CobrarSeventeenScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarSeventeenBloc, CobrarSeventeenState>(
