import 'bloc/bolex_twentyfour_bloc.dart';
import 'models/bolex_twentyfour_model.dart';
...
class BolexTwentyfourScreen extends StatelessWidget {
  const BolexTwentyfourScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<BolexTwentyfourBloc>(
      create: (context) => BolexTwentyfourBloc(BolexTwentyfourState(
        bolexTwentyfourModelObj: BolexTwentyfourModel(),
      ))
        ..add(BolexTwentyfourInitialEvent()),
      child: BolexTwentyfourScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BolexTwentyfourBloc, BolexTwentyfourState>(
