import 'bloc/cobrar_six_bloc.dart';
import 'models/cobrar_six_model.dart';
...
class CobrarSixScreen extends StatelessWidget {
  const CobrarSixScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarSixBloc>(
      create: (context) => CobrarSixBloc(CobrarSixState(
        cobrarSixModelObj: CobrarSixModel(),
      ))
        ..add(CobrarSixInitialEvent()),
      child: CobrarSixScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarSixBloc, CobrarSixState>(
