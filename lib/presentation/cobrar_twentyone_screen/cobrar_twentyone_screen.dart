import 'bloc/cobrar_twentyone_bloc.dart';
import 'models/cobrar_twentyone_model.dart';
...
class CobrarTwentyoneScreen extends StatelessWidget {
  const CobrarTwentyoneScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarTwentyoneBloc>(
      create: (context) => CobrarTwentyoneBloc(CobrarTwentyoneState(
        cobrarTwentyoneModelObj: CobrarTwentyoneModel(),
      ))
        ..add(CobrarTwentyoneInitialEvent()),
      child: CobrarTwentyoneScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarTwentyoneBloc, CobrarTwentyoneState>(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "lbl_por_revoga_o".tr.toUpperCase(),
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.left,
