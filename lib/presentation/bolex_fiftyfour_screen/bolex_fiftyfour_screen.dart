import 'bloc/bolex_fiftyfour_bloc.dart';
import 'models/bolex_fiftyfour_model.dart';
...
class BolexFiftyfourScreen extends StatelessWidget {
  const BolexFiftyfourScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<BolexFiftyfourBloc>(
      create: (context) => BolexFiftyfourBloc(BolexFiftyfourState(
        bolexFiftyfourModelObj: BolexFiftyfourModel(),
      ))
        ..add(BolexFiftyfourInitialEvent()),
      child: BolexFiftyfourScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BolexFiftyfourBloc, BolexFiftyfourState>(
