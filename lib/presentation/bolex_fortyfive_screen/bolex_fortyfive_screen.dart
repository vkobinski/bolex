import 'bloc/bolex_fortyfive_bloc.dart';
import 'models/bolex_fortyfive_model.dart';
...
class BolexFortyfiveScreen extends StatelessWidget {
  const BolexFortyfiveScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<BolexFortyfiveBloc>(
      create: (context) => BolexFortyfiveBloc(BolexFortyfiveState(
        bolexFortyfiveModelObj: BolexFortyfiveModel(),
      ))
        ..add(BolexFortyfiveInitialEvent()),
      child: BolexFortyfiveScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BolexFortyfiveBloc, BolexFortyfiveState>(
