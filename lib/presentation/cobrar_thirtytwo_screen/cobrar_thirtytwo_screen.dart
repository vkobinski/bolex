import 'bloc/cobrar_thirtytwo_bloc.dart';
import 'models/cobrar_thirtytwo_model.dart';
...
class CobrarThirtytwoScreen extends StatelessWidget {
  const CobrarThirtytwoScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarThirtytwoBloc>(
      create: (context) => CobrarThirtytwoBloc(CobrarThirtytwoState(
        cobrarThirtytwoModelObj: CobrarThirtytwoModel(),
      ))
        ..add(CobrarThirtytwoInitialEvent()),
      child: CobrarThirtytwoScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarThirtytwoBloc, CobrarThirtytwoState>(
