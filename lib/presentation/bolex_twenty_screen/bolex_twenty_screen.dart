import 'bloc/bolex_twenty_bloc.dart';
import 'models/bolex_twenty_model.dart';
...
class BolexTwentyScreen extends StatelessWidget {
  const BolexTwentyScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<BolexTwentyBloc>(
      create: (context) => BolexTwentyBloc(BolexTwentyState(
        bolexTwentyModelObj: BolexTwentyModel(),
      ))
        ..add(BolexTwentyInitialEvent()),
      child: BolexTwentyScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BolexTwentyBloc, BolexTwentyState>(
