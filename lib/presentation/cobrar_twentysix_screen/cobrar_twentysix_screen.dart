import 'bloc/cobrar_twentysix_bloc.dart';
import 'models/cobrar_twentysix_model.dart';
...
class CobrarTwentysixScreen extends StatelessWidget {
  const CobrarTwentysixScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarTwentysixBloc>(
      create: (context) => CobrarTwentysixBloc(CobrarTwentysixState(
        cobrarTwentysixModelObj: CobrarTwentysixModel(),
      ))
        ..add(CobrarTwentysixInitialEvent()),
      child: CobrarTwentysixScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarTwentysixBloc, CobrarTwentysixState>(
