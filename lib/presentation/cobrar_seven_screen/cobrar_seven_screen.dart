import 'bloc/cobrar_seven_bloc.dart';
import 'models/cobrar_seven_model.dart';
...
class CobrarSevenScreen extends StatelessWidget {
  const CobrarSevenScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarSevenBloc>(
      create: (context) => CobrarSevenBloc(CobrarSevenState(
        cobrarSevenModelObj: CobrarSevenModel(),
      ))
        ..add(CobrarSevenInitialEvent()),
      child: CobrarSevenScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarSevenBloc, CobrarSevenState>(
