import 'bloc/cobrar_thirty_bloc.dart';
import 'models/cobrar_thirty_model.dart';
...
class CobrarThirtyScreen extends StatelessWidget {
  const CobrarThirtyScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarThirtyBloc>(
      create: (context) => CobrarThirtyBloc(CobrarThirtyState(
        cobrarThirtyModelObj: CobrarThirtyModel(),
      ))
        ..add(CobrarThirtyInitialEvent()),
      child: CobrarThirtyScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarThirtyBloc, CobrarThirtyState>(
