import 'bloc/bolex_eighty_bloc.dart';
import 'models/bolex_eighty_model.dart';
...
class BolexEightyScreen extends StatelessWidget {
  const BolexEightyScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<BolexEightyBloc>(
      create: (context) => BolexEightyBloc(BolexEightyState(
        bolexEightyModelObj: BolexEightyModel(),
      ))
        ..add(BolexEightyInitialEvent()),
      child: BolexEightyScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BolexEightyBloc, BolexEightyState>(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "lbl_maria_santos2".tr.toUpperCase(),
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.left,
