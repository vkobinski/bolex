import 'bloc/cobrar_nineteen_bloc.dart';
import 'models/cobrar_nineteen_model.dart';
...
class CobrarNineteenScreen extends StatelessWidget {
  const CobrarNineteenScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarNineteenBloc>(
      create: (context) => CobrarNineteenBloc(CobrarNineteenState(
        cobrarNineteenModelObj: CobrarNineteenModel(),
      ))
        ..add(CobrarNineteenInitialEvent()),
      child: CobrarNineteenScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarNineteenBloc, CobrarNineteenState>(
