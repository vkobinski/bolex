import 'bloc/bolex_seventythree_bloc.dart';
import 'models/bolex_seventythree_model.dart';
...
class BolexSeventythreeScreen extends StatelessWidget {
  const BolexSeventythreeScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<BolexSeventythreeBloc>(
      create: (context) => BolexSeventythreeBloc(BolexSeventythreeState(
        bolexSeventythreeModelObj: BolexSeventythreeModel(),
      ))
        ..add(BolexSeventythreeInitialEvent()),
      child: BolexSeventythreeScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BolexSeventythreeBloc, BolexSeventythreeState>(
