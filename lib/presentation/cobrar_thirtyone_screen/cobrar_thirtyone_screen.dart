import 'bloc/cobrar_thirtyone_bloc.dart';
import 'models/cobrar_thirtyone_model.dart';
...
class CobrarThirtyoneScreen extends StatelessWidget {
  const CobrarThirtyoneScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarThirtyoneBloc>(
      create: (context) => CobrarThirtyoneBloc(CobrarThirtyoneState(
        cobrarThirtyoneModelObj: CobrarThirtyoneModel(),
      ))
        ..add(CobrarThirtyoneInitialEvent()),
      child: CobrarThirtyoneScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarThirtyoneBloc, CobrarThirtyoneState>(
