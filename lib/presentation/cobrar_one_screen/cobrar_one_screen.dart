import 'bloc/cobrar_one_bloc.dart';
import 'models/cobrar_one_model.dart';
...
class CobrarOneScreen extends StatelessWidget {
  const CobrarOneScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarOneBloc>(
      create: (context) => CobrarOneBloc(CobrarOneState(
        cobrarOneModelObj: CobrarOneModel(),
      ))
        ..add(CobrarOneInitialEvent()),
      child: CobrarOneScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarOneBloc, CobrarOneState>(
