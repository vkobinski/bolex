import 'bloc/cobrar_thirteen_bloc.dart';
import 'models/cobrar_thirteen_model.dart';
...
class CobrarThirteenScreen extends StatelessWidget {
  const CobrarThirteenScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarThirteenBloc>(
      create: (context) => CobrarThirteenBloc(CobrarThirteenState(
        cobrarThirteenModelObj: CobrarThirteenModel(),
      ))
        ..add(CobrarThirteenInitialEvent()),
      child: CobrarThirteenScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarThirteenBloc, CobrarThirteenState>(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "msg_saldo_insuficiente".tr.toUpperCase(),
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.left,
