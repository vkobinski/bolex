import 'bloc/bolex_sixteen_bloc.dart';
import 'models/bolex_sixteen_model.dart';
...
class BolexSixteenScreen extends StatelessWidget {
  const BolexSixteenScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<BolexSixteenBloc>(
      create: (context) => BolexSixteenBloc(BolexSixteenState(
        bolexSixteenModelObj: BolexSixteenModel(),
      ))
        ..add(BolexSixteenInitialEvent()),
      child: BolexSixteenScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BolexSixteenBloc, BolexSixteenState>(
