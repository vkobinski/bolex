import 'bloc/cobrar_twentythree_bloc.dart';
import 'models/cobrar_twentythree_model.dart';
...
class CobrarTwentythreeScreen extends StatelessWidget {
  const CobrarTwentythreeScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarTwentythreeBloc>(
      create: (context) => CobrarTwentythreeBloc(CobrarTwentythreeState(
        cobrarTwentythreeModelObj: CobrarTwentythreeModel(),
      ))
        ..add(CobrarTwentythreeInitialEvent()),
      child: CobrarTwentythreeScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarTwentythreeBloc, CobrarTwentythreeState>(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomElevatedButton(
                    text: "msg_confirmar_protesto".tr,
