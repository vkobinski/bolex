import 'bloc/cobrar_twentynine_bloc.dart';
import 'models/cobrar_twentynine_model.dart';
...
class CobrarTwentynineScreen extends StatelessWidget {
  const CobrarTwentynineScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarTwentynineBloc>(
      create: (context) => CobrarTwentynineBloc(CobrarTwentynineState(
        cobrarTwentynineModelObj: CobrarTwentynineModel(),
      ))
        ..add(CobrarTwentynineInitialEvent()),
      child: CobrarTwentynineScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarTwentynineBloc, CobrarTwentynineState>(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomElevatedButton(
                    text: "msg_confirmar_liquida_o".tr,
