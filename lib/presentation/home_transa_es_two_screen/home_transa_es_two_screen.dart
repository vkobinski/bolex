import '../home_transa_es_two_screen/widgets/aes2_item_widget.dart';
import 'bloc/home_transa_es_two_bloc.dart';
import 'models/aes2_item_model.dart';
import 'models/home_transa_es_two_model.dart';
...
class HomeTransaEsTwoScreen extends StatelessWidget {
  const HomeTransaEsTwoScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<HomeTransaEsTwoBloc>(
      create: (context) => HomeTransaEsTwoBloc(HomeTransaEsTwoState(
        homeTransaEsTwoModelObj: HomeTransaEsTwoModel(),
      ))
        ..add(HomeTransaEsTwoInitialEvent()),
      child: HomeTransaEsTwoScreen(),
    );
  }
                    ...
                    children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: BlocSelector<HomeTransaEsTwoBloc,
                                    HomeTransaEsTwoState, bool?>(
                                  ...
                                  builder: (context, isCheckbox) {
                                    return CustomCheckboxButton(
                                      ...
                                      isRightCheck: true,
                                      onChange: (value) {
                                        context.read<HomeTransaEsTwoBloc>().add(
                      ...
                      Align(
                        ...
                        child: SizedBox(
                          ...
                          child: BlocSelector<HomeTransaEsTwoBloc,
                              HomeTransaEsTwoState, HomeTransaEsTwoModel?>(
                            selector: (state) => state.homeTransaEsTwoModelObj,
                            builder: (context, homeTransaEsTwoModelObj) {
                              return ListView.separated(
                                ...
                                itemCount: homeTransaEsTwoModelObj
                                        ?.aes2ItemList.length ??
                                    0,
                                itemBuilder: (context, index) {
                                  Aes2ItemModel model = homeTransaEsTwoModelObj
                                          ?.aes2ItemList[index] ??
                                      Aes2ItemModel();
                                  return Aes2ItemWidget(
                                    model,
                                  );
                                },
                              );
