import 'bloc/bolex_twentytwo_bloc.dart';
import 'models/bolex_twentytwo_model.dart';
...
class BolexTwentytwoScreen extends StatelessWidget {
  const BolexTwentytwoScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<BolexTwentytwoBloc>(
      create: (context) => BolexTwentytwoBloc(BolexTwentytwoState(
        bolexTwentytwoModelObj: BolexTwentytwoModel(),
      ))
        ..add(BolexTwentytwoInitialEvent()),
      child: BolexTwentytwoScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BolexTwentytwoBloc, BolexTwentytwoState>(
