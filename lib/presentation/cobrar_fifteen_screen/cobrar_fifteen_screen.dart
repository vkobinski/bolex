import 'bloc/cobrar_fifteen_bloc.dart';
import 'models/cobrar_fifteen_model.dart';
...
class CobrarFifteenScreen extends StatelessWidget {
  const CobrarFifteenScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarFifteenBloc>(
      create: (context) => CobrarFifteenBloc(CobrarFifteenState(
        cobrarFifteenModelObj: CobrarFifteenModel(),
      ))
        ..add(CobrarFifteenInitialEvent()),
      child: CobrarFifteenScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarFifteenBloc, CobrarFifteenState>(
