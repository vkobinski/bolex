import 'bloc/bolex_fortysix_bloc.dart';
import 'models/bolex_fortysix_model.dart';
...
class BolexFortysixScreen extends StatelessWidget {
  const BolexFortysixScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<BolexFortysixBloc>(
      create: (context) => BolexFortysixBloc(BolexFortysixState(
        bolexFortysixModelObj: BolexFortysixModel(),
      ))
        ..add(BolexFortysixInitialEvent()),
      child: BolexFortysixScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BolexFortysixBloc, BolexFortysixState>(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.left,
                      style: CustomTextStyles.titleLargeRedA70001.copyWith(
                        letterSpacing: getHorizontalSize(
                          0.8,
                        ),
                      ),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            "msg_recusado_pelo_adquirente".tr,
                            overflow: TextOverflow.ellipsis,
                            textAlign: TextAlign.left,
