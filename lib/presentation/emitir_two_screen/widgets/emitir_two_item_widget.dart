import '../models/emitir_two_item_model.dart';
...
class EmitirTwoItemWidget extends StatelessWidget {
  EmitirTwoItemWidget(
    this.emitirTwoItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  EmitirTwoItemModel emitirTwoItemModelObj;
