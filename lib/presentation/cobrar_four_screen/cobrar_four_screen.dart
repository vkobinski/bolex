import 'bloc/cobrar_four_bloc.dart';
import 'models/cobrar_four_model.dart';
...
class CobrarFourScreen extends StatelessWidget {
  const CobrarFourScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarFourBloc>(
      create: (context) => CobrarFourBloc(CobrarFourState(
        cobrarFourModelObj: CobrarFourModel(),
      ))
        ..add(CobrarFourInitialEvent()),
      child: CobrarFourScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarFourBloc, CobrarFourState>(
