import 'bloc/bolex_thirty_bloc.dart';
import 'models/bolex_thirty_model.dart';
...
class BolexThirtyScreen extends StatelessWidget {
  const BolexThirtyScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<BolexThirtyBloc>(
      create: (context) => BolexThirtyBloc(BolexThirtyState(
        bolexThirtyModelObj: BolexThirtyModel(),
      ))
        ..add(BolexThirtyInitialEvent()),
      child: BolexThirtyScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BolexThirtyBloc, BolexThirtyState>(
