import 'bloc/bolex_ten_bloc.dart';
import 'models/bolex_ten_model.dart';
...
class BolexTenScreen extends StatelessWidget {
  const BolexTenScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<BolexTenBloc>(
      create: (context) => BolexTenBloc(BolexTenState(
        bolexTenModelObj: BolexTenModel(),
      ))
        ..add(BolexTenInitialEvent()),
      child: BolexTenScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BolexTenBloc, BolexTenState>(
          ...
          child: Scaffold(
            ...
            appBar: CustomAppBar(
              ...
              title: AppbarSubtitle(
                text: "msg_pagamento_a_prazo2".tr,
              ),
              actions: [
                AppbarImage(
                  height: getVerticalSize(
                        ...
                        children: [
                          Expanded(
                            child: CustomElevatedButton(
                              text: "msg_pagamento_em_10x".tr.toUpperCase(),
