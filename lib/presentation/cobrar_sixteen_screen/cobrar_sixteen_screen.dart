import 'bloc/cobrar_sixteen_bloc.dart';
import 'models/cobrar_sixteen_model.dart';
...
class CobrarSixteenScreen extends StatelessWidget {
  const CobrarSixteenScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarSixteenBloc>(
      create: (context) => CobrarSixteenBloc(CobrarSixteenState(
        cobrarSixteenModelObj: CobrarSixteenModel(),
      ))
        ..add(CobrarSixteenInitialEvent()),
      child: CobrarSixteenScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarSixteenBloc, CobrarSixteenState>(
