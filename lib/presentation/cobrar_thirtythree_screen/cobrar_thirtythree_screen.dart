import 'bloc/cobrar_thirtythree_bloc.dart';
import 'models/cobrar_thirtythree_model.dart';
...
class CobrarThirtythreeScreen extends StatelessWidget {
  const CobrarThirtythreeScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarThirtythreeBloc>(
      create: (context) => CobrarThirtythreeBloc(CobrarThirtythreeState(
        cobrarThirtythreeModelObj: CobrarThirtythreeModel(),
      ))
        ..add(CobrarThirtythreeInitialEvent()),
      child: CobrarThirtythreeScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarThirtythreeBloc, CobrarThirtythreeState>(
