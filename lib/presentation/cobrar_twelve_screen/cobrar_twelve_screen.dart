import 'bloc/cobrar_twelve_bloc.dart';
import 'models/cobrar_twelve_model.dart';
...
class CobrarTwelveScreen extends StatelessWidget {
  const CobrarTwelveScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarTwelveBloc>(
      create: (context) => CobrarTwelveBloc(CobrarTwelveState(
        cobrarTwelveModelObj: CobrarTwelveModel(),
      ))
        ..add(CobrarTwelveInitialEvent()),
      child: CobrarTwelveScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarTwelveBloc, CobrarTwelveState>(
