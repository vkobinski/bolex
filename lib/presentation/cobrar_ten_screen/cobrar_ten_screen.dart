import 'bloc/cobrar_ten_bloc.dart';
import 'models/cobrar_ten_model.dart';
...
class CobrarTenScreen extends StatelessWidget {
  const CobrarTenScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarTenBloc>(
      create: (context) => CobrarTenBloc(CobrarTenState(
        cobrarTenModelObj: CobrarTenModel(),
      ))
        ..add(CobrarTenInitialEvent()),
      child: CobrarTenScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarTenBloc, CobrarTenState>(
          ...
          child: Scaffold(
            ...
            appBar: CustomAppBar(
              ...
              title: AppbarSubtitle3(
                text: "msg_antecipar_pagamento3".tr,
              ),
              actions: [
                AppbarImage(
                  height: getVerticalSize(
