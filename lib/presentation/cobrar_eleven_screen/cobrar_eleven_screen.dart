import 'bloc/cobrar_eleven_bloc.dart';
import 'models/cobrar_eleven_model.dart';
...
class CobrarElevenScreen extends StatelessWidget {
  const CobrarElevenScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<CobrarElevenBloc>(
      create: (context) => CobrarElevenBloc(CobrarElevenState(
        cobrarElevenModelObj: CobrarElevenModel(),
      ))
        ..add(CobrarElevenInitialEvent()),
      child: CobrarElevenScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CobrarElevenBloc, CobrarElevenState>(
